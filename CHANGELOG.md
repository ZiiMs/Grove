...
## [0.3.0](https://github.com/ZiiMs/Grove/compare/v0.2.0...v0.3.0) - 2026-03-05

### Other

- Fix pause overlay error wrapping and satisfy clippy
- Improve paused checkout resume flow and error overlay
- Create LICENSE
...
## [0.1.2](https://github.com/ZiiMs/Grove/compare/v0.1.1...v0.1.2) - 2026-02-26
